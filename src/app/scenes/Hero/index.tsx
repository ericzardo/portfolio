...
export default function HeroScene() {
  ...
  return (
    <div className="flex min-h-dvh w-full select-none flex-col justify-center gap-3 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-48">
      ...
      <h1 className="text-xl text-950 sm:text-2xl md:text-3xl">
        Hey, I&apos;m{' '}
