    ...
    >
      <span className="flex items-center justify-center">
        ...
        <div className="relative flex flex-col items-end justify-center gap-2.5">
          ...
          <div id="quote-icon" className="absolute -left-14 -top-16 z-0 flex size-fit items-center justify-center sm:-left-16 sm:-top-24 md:-left-20 md:-top-28 lg:-left-24 lg:-top-32">
